<script lang="ts">
  ...
  import SearchByCommune from "$lib/components/establishment-search/search-by-commune.svelte";
  import SearchBySiret from "$lib/components/establishment-search/search-by-siret.svelte";
