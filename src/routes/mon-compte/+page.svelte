<script lang="ts">
  ...
  import CategoryLabel from "$lib/components/specialized/services/category-label.svelte";
...
<EnsureLoggedIn>
  ...
  <div class="flex gap-s40 md:flex-col">
          ...
          <div class="flex flex-col gap-s35 p-s32">
            <div>
              ...
              <ul class="ml-s28 list-disc text-f16 text-gray-text">
                <li>
                  Je consulte les offres d’insertion de mon territoire à des
                  fins d’orientation et de veille
                </li>
              </ul>
            </div>

            <div>
              <h3 class="mb-s8 text-f18 leading-20">
              ...
              <div class="flex flex-wrap gap-s10">
                <!-- TODO -->
                <CategoryLabel
                  categorySlug="creation-activite"
      ...
      <div class="flex flex-1 flex-col gap-s24">
        {#if $userInfo.isStaff}
          <div class="mb-s24 rounded-md border border-gray-03 p-s24">
            <h2 class="mb-s20 text-f18 leading-20 text-gray-dark">
              Raccourcis
            </h2>
