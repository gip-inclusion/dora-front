  ...
  <FieldSet headerBg="bg-magenta-brand" noHeaderBorder noTopPadding>
    <div class="flex-1">
      ...
      <div class="mb-s40 text-center">
        ...
        >
          <div
            class="mx-auto flex items-center justify-center rounded-full bg-france-blue p-s6 pr-s24 text-f16 text-white transition-colors hover:bg-france-blue-hover"
          >
